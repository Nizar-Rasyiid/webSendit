...
const PaymentPage = () => {
  ...
  const addPayment = async () => {
    try {
      const response = await axios.post("http://192.168.1.5:8000/api/payments", newPayment);
  ...
  const savePayment = async () => {
    try {
      const response = await axios.put(`http://192.168.1.5:8000/api/payments/${editingPayment.id_payment}`, newPayment);
  ...
  const deletePayment = async (id) => {
    try {
      await axios.delete(`http://192.168.1.5:8000/api/payments/${id}`);
